...
vort[0].location(2.5,0)
vort[0].fixed = 1
vort[1].location(-2.5,0)
vort[1].strength = 1
vort[1].fixed = 1
...
vort[2].location(0, 0.5)
vort[4].location(0, 1.5)
vort[6].location(0, 2.5)
vort[8].location(0, 3.5)
vort[10].location(0,4.5)
vort[3].location(0, -0.5)
vort[5].location(0, -1.5)
vort[7].location(0, -2.5)
vort[9].location(0, -3.5)
vort[11].location(0,-4.5)
